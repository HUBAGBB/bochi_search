...
export default async function ImageSearchPage({ searchParams }: Props) {
	...
	*/
	...
	let url = `https://www.googleapis.com/customsearch/v1?key=${
		"AIzaSyBzrAYALLM9IrsQb3LDnmul5_PE0w9wkQQ"
	}&cx=${"352edd94261994a3c"}&q=${
			...
			<div className="flex w-full flex-col items-center justify-center p-4 pb-[6rem] pt-[8rem] ">
				<div className="text-grey-900 mb-8 text-center">
					<p className="rounded border bg-white p-8 text-xl">
						Sorry, no results were found. Please try searching for something
						else or go to{' '}
						<Link
							href="/"
	...
	return <ImageSearchResult searchResult={searchResult || mockedResponse} />
}
